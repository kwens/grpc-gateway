...
gulp.task('server', shell.task([
  'go build -o bin/example-server github.com/kwens/grpc-gateway/v2/examples/internal/cmd/example-grpc-server',
]));

gulp.task('gateway', shell.task([
  'go build -o bin/example-gw github.com/kwens/grpc-gateway/v2/examples/internal/cmd/example-gateway-server',
]));
