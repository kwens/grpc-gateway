...
import (
	...
	"github.com/kwens/grpc-gateway/v2/internal/descriptor/openapiconfig"
...
func TestLoadFile(t *testing.T) {
	...
	fd := loadFile(t, reg, `
		name: 'example.proto'
		package: 'example'
		options < go_package: 'github.com/kwens/grpc-gateway/runtime/internal/example' >
		message_type <
			name: 'ExampleMessage'
			field <
				name: 'str'
	...
	wantPkg := GoPackage{Path: "github.com/kwens/grpc-gateway/runtime/internal/example", Name: "example"}
...
func TestLoadFileNestedPackage(t *testing.T) {
	...
	loadFile(t, reg, `
		...
		options < go_package: 'github.com/kwens/grpc-gateway/runtime/internal/example.nested.nested2' >
	`)
	...
	wantPkg := GoPackage{Path: "github.com/kwens/grpc-gateway/runtime/internal/example.nested.nested2", Name: "example_nested_nested2"}
	if got, want := file.GoPkg, wantPkg; got != want {
		t.Errorf("file.GoPkg = %#v; want %#v", got, want)
	}
}
...
func TestLoadFileWithoutPackage(t *testing.T) {
	...
	loadFile(t, reg, `
		...
		options < go_package: 'github.com/kwens/grpc-gateway/runtime/internal/example_file' >
	`)
	...
	wantPkg := GoPackage{Path: "github.com/kwens/grpc-gateway/runtime/internal/example_file", Name: "example_file"}
	if got, want := file.GoPkg, wantPkg; got != want {
		t.Errorf("file.GoPkg = %#v; want %#v", got, want)
	}
}
...
func TestLoadFileWithPackageNameCollision(t *testing.T) {
	...
	loadFile(t, reg, `
		...
		package: 'ioutil'
		options < go_package: 'github.com/kwens/grpc-gateway/runtime/internal/ioutil' >
	`)
	...
	wantPkg = GoPackage{Path: "github.com/kwens/grpc-gateway/runtime/internal/example", Name: "example", Alias: ""}
	if got, want := file.GoPkg, wantPkg; got != want {
		t.Errorf("file.GoPkg = %#v; want %#v", got, want)
	}
	...
	wantPkg = GoPackage{Path: "github.com/kwens/grpc-gateway/runtime/internal/ioutil", Name: "ioutil", Alias: "ioutil_0"}
	if got, want := file.GoPkg, wantPkg; got != want {
		t.Errorf("file.GoPkg = %#v; want %#v", got, want)
	}
}
	...
	for _, spec := range []struct {
		...
		// root package, explicit go package
		{
			req: `
				...
				proto_file <
					name: 'a.proto'
					options < go_package: 'github.com/kwens/grpc-gateway/runtime/internal/example.foo' >
					message_type < name: 'A' >
					service <
						name: "AService"
						method <
