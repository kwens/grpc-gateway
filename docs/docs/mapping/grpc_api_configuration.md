...
OpenAPI options may also be configured via ["OpenAPI Configuration"](https://github.com/kwens/grpc-gateway/tree/main/internal/descriptor/openapiconfig/openapiconfig.proto) in the form of YAML configuration files.

### Usage of gRPC API Configuration YAML files

The following is equivalent to the basic [`README.md`](https://github.com/kwens/grpc-gateway/blob/main/README.md#usage) example but without direct
...
6. Generate the optional your_service.swagger.json
   ...
   For an example of an OpenAPI configuration file, see [unannotated_echo_service.swagger.yaml](https://github.com/kwens/grpc-gateway/tree/main/examples/internal/proto/examplepb/unannotated_echo_service.swagger.yaml), which adds OpenAPI options to [unannotated_echo_service.proto](https://github.com/kwens/grpc-gateway/tree/main/examples/internal/proto/examplepb/unannotated_echo_service.proto).
