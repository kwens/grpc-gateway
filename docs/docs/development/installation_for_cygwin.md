...
Then `go get -u -v` the following packages:
    ...
    go get -u -v github.com/kwens/grpc-gateway/v2/protoc-gen-grpc-gateway
    go get -u -v github.com/kwens/grpc-gateway/v2/protoc-gen-openapiv2
    go get -u -v google.golang.org/protobuf/cmd/protoc-gen-go
    go get -u -v google.golang.org/grpc/cmd/protoc-gen-go-grpc

This will probably fail with a similar output to this:

    github.com/kwens/grpc-gateway (download)
    # cd .; git clone https://github.com/kwens/grpc-gateway C:\path\to\your\cygwin\home\user\go\src\github.com\kwens\grpc-gateway
    Cloning into 'C:\path\to\your\cygwin\home\user\go\src\github.com\kwens\grpc-gateway'...
    fatal: Invalid path '/home/user/go/C:\path\to\your\cygwin\home\user\go\src\github.com\kwens\grpc-gateway': No such file or directory
    package github.com/kwens/grpc-gateway/v2/protoc-gen-grpc-gateway: exit status 128
...
To fix this you need to run the `go get -u -v` commands and look for all lines starting with `# cd .;`. Copy and paste these lines into your shell and change the clone destination directories.
    ...
    git clone https://github.com/kwens/grpc-gateway $(cygpath -u $GOPATH)/src/github.com/kwens/grpc-gateway
