...
- [ ] Check if your issue has already been reported (https://github.com/kwens/grpc-gateway/issues).
...
- [ ] Update your copy of the `grpc-gateway` library to the latest version from github:
  ```sh
  go get github.com/kwens/grpc-gateway/v2@latest
  ```
- [ ] Delete the `protoc-gen-grpc-gateway` and `protoc-gen-openapiv2` binary from your `PATH`, and reinstall the latest versions:

  ```sh
  go get github.com/kwens/grpc-gateway/v2/protoc-gen-grpc-gateway
  go get github.com/kwens/grpc-gateway/v2/protoc-gen-openapiv2
  ```
